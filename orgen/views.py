...
#         # نجيب اليوزر الأول عشان نعرف نوعه الحقيقي
#         try:
#             patient = User.objects.get(id=patient_id)
#         except User.DoesNotExist:
#             return Response(
#                 {"error": "patient_id غير موجود"},
...
#             # لو أي API رجع status code غير 200، نعتبرها فشلت
#             if cv_response.status_code != 200 or nlp_response.status_code != 200:
#                 return Response(
#                     {
#                         "status": "failed",
#                         "patient_id": patient_id,
#                         "error": "أحد خدمات الـ AI رجع خطأ",
#                         "cv_status_code": cv_response.status_code,
#                         "nlp_status_code": nlp_response.status_code,
#                     },
...
#             return Response({
#                 "status": "mismatch_found" if mismatch_alert else "success",
#                 "patient_id": patient_id,
#                 "user_type": patient.role,
#                 "mismatch_alert": mismatch_alert,
...
class VerifyCVNLPViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        try:
            ...
            # نرجع المؤشر لأول الملفات بعد القراءة عشان نقدر نحفظهم لاحقاً
            before_scan.seek(0)
            after_scan.seek(0)
